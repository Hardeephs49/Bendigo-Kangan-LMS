...
const Dashboard: React.FC = () => {
  ...
  const userCourses = courses; // Now `courses` are fetched from API based on role.
    ...
    <Layout>
      <Box
        sx={{
          ...
          minHeight: '60vh',
          width: '100%',
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.7)), url(images/mainBg1.jpg)`,
